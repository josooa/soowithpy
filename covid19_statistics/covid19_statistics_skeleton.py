...
sum_people = sum(n for idx, n in enumerate(n_people)) # TODO) Compute the total number of people
sum_covid  = sum(n for idx, n in enumerate(n_covid)) # TODO) Compute the total number of new cases
...
print('| ------ | ---------- | --------- | ----------------- |')
for idx, pop in enumerate(n_people):
    ratio = n_covid[idx] / sum_covid * 100 if sum_covid > 0 else 0
